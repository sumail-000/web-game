...
const GamesPage = () => {
  ...
  const topTrendingGames = [
    ...
    { id: 2, title: "[💸] Build a Scam Empire!", rating: 98, players: "6.8K", image: "https://robohash.org/game2?set=set4" },
    { id: 3, title: "Spot The Differences! 🔎", rating: 89, players: "598", image: "https://robohash.org/game3?set=set4" },
    { id: 4, title: "[CHRISTMAS] Car Crash Simulator V3", rating: 83, players: "7.8K", image: "https://robohash.org/game4?set=set4" },
    { id: 5, title: "[BIG UPDATE] Aura Edit Tower 🎵", rating: 83, players: "215K", image: "https://robohash.org/game5?set=set4" },
    { id: 6, title: "SLAP", rating: 95, players: "3.4K", image: "https://robohash.org/game6?set=set4" },
    { id: 7, title: "Build a Waterslide 💦", rating: 82, players: "12.8K", image: "https://robohash.org/game7?set=set4" },
  ...
  const upAndComingGames = [
    ...
    { id: 11, title: "⚔️blade battle", rating: 92, players: "3.9K", image: "https://robohash.org/game11?set=set4" },
    { id: 12, title: "Get Tall and Fall [🔥World 5]", rating: 98, players: "33.6K", image: "https://robohash.org/game12?set=set4" },
    { id: 13, title: "[🚂] train ur troops! 😡", rating: 97, players: "6K", image: "https://robohash.org/game13?set=set4" },
    { id: 14, title: "🔨Dig to Escape", rating: 92, players: "71.7K", image: "https://robohash.org/game14?set=set4" },
    { id: 15, title: "My Plane Hangar ✈️ [NEW]", rating: 93, players: "2.3K", image: "https://robohash.org/game15?set=set4" },
    { id: 16, title: "Drift Paradise", rating: 91, players: "5.1K", image: "https://robohash.org/game16?set=set4" },
  ];

  const topPlayingNowGames = [
    { id: 17, title: "99 Nights in the Forest 🦅", rating: 91, players: "1M", image: "https://robohash.org/game17?set=set4" },
    { id: 18, title: "Fish It! 🐟", rating: 84, players: "986K", image: "https://robohash.org/game18?set=set4" },
    { id: 19, title: "Brookhaven 🏡RP", rating: 85, players: "656.3K", image: "https://robohash.org/game19?set=set4" },
    { id: 20, title: "[🅰️] Steal a Brainrot", rating: 86, players: "604.2K", image: "https://robohash.org/game20?set=set4" },
    { id: 21, title: "The Forge [BETA]", rating: 96, players: "407.2K", image: "https://robohash.org/game21?set=set4" },
    { id: 22, title: "[🅰️] RIVALS", rating: 94, players: "380.1K", image: "https://robohash.org/game22?set=set4" },
    { id: 23, title: "[🎁 DAY 12] Adopt Me!", rating: 84, players: "334.9K", image: "https://robohash.org/game23?set=set4" },
  ...
  const topRatedGames = [
    ...
    { id: 26, title: "FLASHPOINT⚡", rating: 98, players: "1.8K", image: "https://robohash.org/game26?set=set4" },
    { id: 27, title: "[🏆] Garden Tower Defense 🌿", rating: 98, players: "11.5K", image: "https://robohash.org/game27?set=set4" },
    { id: 28, title: "Grow a Friend () 💪", rating: 98, players: "154", image: "https://robohash.org/game28?set=set4" },
    { id: 29, title: "[😈 9.5 😇] Anime Vanguards", rating: 96, players: "68.3K", image: "https://robohash.org/game29?set=set4" },
    { id: 30, title: "Jule's RNG [EVO 6+7]", rating: 98, players: "663", image: "https://robohash.org/game30?set=set4" },
    { id: 31, title: "SpongeBob Tower Defense🧽", rating: 98, players: "12.7K", image: "https://robohash.org/game31?set=set4" },
    { id: 32, title: "Arena World", rating: 97, players: "8.2K", image: "https://robohash.org/game32?set=set4" },
  ];

  const topPaidAccessGames = [
    { id: 33, title: "[🩸] Bloodlines", rating: 81, players: "1.7K", image: "https://robohash.org/game33?set=set4" },
    ...
    { id: 36, title: "[🎨] Avatar Graphics Creator", rating: 71, players: "30", image: "https://robohash.org/game36?set=set4" },
    { id: 37, title: "[WINTER❄️] Cruise Line Tycoon", rating: 91, players: "142", image: "https://robohash.org/game37?set=set4" },
    { id: 38, title: "Project Flight | Early Access Pre-Alpha", rating: 92, players: "583", image: "https://robohash.org/game38?set=set4" },
    { id: 39, title: "[WIPE] Fallen Survival💀", rating: 85, players: "500", image: "https://robohash.org/game39?set=set4" },
  ...
  const trendingMusicGames = [
    ...
    { id: 43, title: "The Corner 🔊", rating: 88, players: "4K", image: "https://robohash.org/game43?set=set4" },
    { id: 44, title: "🔺 Ro-vibes 🔊", rating: 93, players: "142", image: "https://robohash.org/game44?set=set4" },
  ...
  const funWithFriendsGames = [
    ...
    { id: 52, title: "The Corner 🔊", rating: 88, players: "4K", image: "https://robohash.org/game52?set=set4" },
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="max-w-[1920px] mx-auto px-4 py-6">
        ...
        <GameSection title="Trending Music Experiences" games={trendingMusicGames} info="Discover more music. See Music Top 100 ›" />
